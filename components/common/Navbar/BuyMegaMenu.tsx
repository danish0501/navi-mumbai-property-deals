...
import { ChevronRight, Home, Map, BriefcaseBusiness, MapPin, BookOpenText, TrendingUp } from 'lucide-react';
...
// Live Market Stats for Local E-E-A-T
const areaStats: Record<string, string> = {
    "Vashi": "₹16,500/sqft (+2% YoY)",
    "Nerul": "₹14,200/sqft (+1.5% YoY)",
    "Belapur": "₹13,800/sqft (+3% YoY)",
    "Kharghar": "₹10,200/sqft (+5% YoY)",
    "Panvel": "₹7,200/sqft (+8% YoY)"
};
            ...
            <div className="w-full bg-zinc-900 text-white py-4 px-8 flex items-center justify-between z-20">
                <div className="flex items-center gap-6">
                    <div className="flex flex-col gap-0.5">
                        <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest leading-none mb-1">Live Market Stats</span>
                        <span className="text-white font-extrabold text-lg leading-tight">
                            {activeCategory === "Popular Areas" ? "Real-time Locality Rates" : `Navi Mumbai ${activeCategory} Prices`}
                        </span>
                    </div>
                    ...
                    <div className="hidden md:flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-xs font-bold text-zinc-100 italic">{areaStats[activeCategory] || "Avg. ₹12,500/sqft"}</span>
                        </div>
                    </div>
                </div>
                <div className="flex items-center gap-4">
                    <Link href={buyMegaMenuData[activeCategory][0]?.href || "/buy"}>

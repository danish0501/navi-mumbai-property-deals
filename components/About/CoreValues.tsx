...
const valueCards = [
    {
        icon: <ShieldCheck className="w-10 max-[376px]:w-8 h-10 max-[376px]:h-8" aria-hidden="true" />,
    ...
    {
        icon: <Eye className="w-10 max-[376px]:w-8 h-10 max-[376px]:h-8" aria-hidden="true" />,
    ...
    {
        icon: <Handshake className="w-10 max-[376px]:w-8 h-10 max-[376px]:h-8" aria-hidden="true" />,
    ...
    {
        icon: <Headset className="w-10 max-[376px]:w-8 h-10 max-[376px]:h-8" aria-hidden="true" />,
    ...
    return (
        <section className="py-16 bg-white relative overflow-hidden">
            ...
            <div className="container mx-auto px-6 relative">
                <div className="max-w-4xl mx-auto text-center mb-20 max-[376px]:mb-10">
                    <motion.div
                    ...
                    <motion.h2
                        ...
                        viewport={{ once: true }}
                        className="text-4xl md:text-6xl max-[376px]:text-3xl max-[321px]:text-2xl font-black text-zinc-950 leading-[1.1] mb-6"
                    >
                    ...
                    <motion.p
                        ...
                        className="text-zinc-500 text-lg md:text-xl max-[376px]:text-base leading-relaxed max-w-4xl mx-auto"
                    >
                        ...
                        >
                            <div className="h-full bg-white rounded-[2.4rem] p-8 md:p-10 border border-zinc-100 flex flex-col md:flex-row gap-8">
                                <div className="flex-shrink-0">
                                    <div className="w-20 max-[376px]:w-14 h-20 max-[376px]:h-14 rounded-2xl bg-zinc-50 flex items-center justify-center text-brand-primary group-hover:bg-brand-primary group-hover:text-white transition-all duration-500 shadow-inner group-hover:rotate-6">
                                        {card.icon}
                                    </div>
                                </div>
                                <div className="flex-grow">
                                    <span className="text-brand-primary font-bold text-xs uppercase tracking-widest max-[321px]:tracking-wide mb-2 block">
                                        {card.subtitle}
                                    </span>
                                    <h3 className="text-2xl max-[376px]:text-xl max-[321px]:text-base font-black text-zinc-900 mb-4 group-hover:translate-x-1 transition-transform">
                                        {card.title}
                                    </h3>
                                    <p className="text-zinc-500 leading-relaxed mb-8 max-[321px]:text-sm">
                                        {card.description}
                                    </p>

                                    <div className="grid sm:grid-cols-1 gap-3">
                                        {card.features.map((feature, fIdx) => (
                                            <div key={fIdx} className="flex items-center gap-3 max-[321px]:gap-1 text-sm max-[321px]:text-xs font-bold text-zinc-700">
                ...
                >
                    <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-xl bg-brand-primary text-white flex items-center justify-center shadow-lg shadow-brand-primary/20 max-[769px]:hidden">

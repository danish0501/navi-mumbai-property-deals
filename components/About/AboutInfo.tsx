...
const features = [
    {
        ...
        description: "Capital values in nodes like Ulwe, Kharghar, and Panvel are outpacing Mumbai averages due to MTHL and Navi Mumbai Airport impact.",
        stat: "+15.2%"
    },
    {
        icon: <Landmark className="w-5 h-5" aria-hidden="true" />,
        title: "CIDCO Planned Growth",
        description: "Navi Mumbai is the world's largest planned city by CIDCO, ensuring sustainable long-term infrastructure and quality living.",
        stat: "100% Planned"
    },
    {
        icon: <Zap className="w-5 h-5" aria-hidden="true" />,
        title: "MTHL & Airport Core",
        description: "Strategic proximity to the Atal Setu (MTHL) and upcoming International Airport drives high rental demand in Navi Mumbai nodes.",
        stat: "Tier 1 Hub"
    },
    {
        icon: <BadgeCheck className="w-5 h-5" aria-hidden="true" />,
        title: "RERA Verified Inventory",
        description: "Our legal experts verify every project's RERA status and title history for secure real estate investments in Maharashtra.",
        stat: "100% Secure"
    }
];
                ...
                <div className="grid lg:grid-cols-2 gap-10 xl:gap-14 items-center">
                    ...
                    <div className="relative">
                        <motion.div
                            ...
                            className="relative rounded-[2.5rem] overflow-hidden shadow-2xl border border-zinc-100"
                        >
                            <Image
                            ...
                            {/* Overlay Gradient */}
                            <div className="absolute inset-0 bg-gradient-to-t from-zinc-950/60 via-transparent to-transparent" aria-hidden="true" />
